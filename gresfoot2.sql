...
CREATE TABLE `games` (
  ...
  `des` int(11) NOT NULL,
  `stat1` json DEFAULT NULL,
  `stat2` json DEFAULT NULL,
  `stat3` json DEFAULT NULL,
  `stat4` json DEFAULT NULL,
  `stat5` json DEFAULT NULL,
  `stat6` json DEFAULT NULL,
  `stat7` json DEFAULT NULL,
  `stat8` json DEFAULT NULL,
  `stat9` json DEFAULT NULL,
  `stat10` json DEFAULT NULL,
  `stat11` json DEFAULT NULL,
  `stat12` json DEFAULT NULL,
  `stat13` json DEFAULT NULL
...
--
ALTER TABLE `games`
  ADD CONSTRAINT `games_ibfk_1` FOREIGN KEY (`id_enredo`) REFERENCES `enredos` (`id_enredo`),
  ADD CONSTRAINT `games_ibfk_2` FOREIGN KEY (`id_escola`) REFERENCES `escolas` (`id`),
  ADD CONSTRAINT `games_ibfk_3` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`);

--
-- Limitadores para a tabela `games2`
--
ALTER TABLE `games2`
  ADD CONSTRAINT `games2_ibfk_1` FOREIGN KEY (`id_enredo`) REFERENCES `enredos` (`id_enredo`),
  ADD CONSTRAINT `games2_ibfk_2` FOREIGN KEY (`id_escola`) REFERENCES `escolas` (`id`),
  ADD CONSTRAINT `games2_ibfk_3` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`);
COMMIT;
