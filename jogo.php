    ...
    <div class="container-fluid" >
      <nav class="navbar navbar-default">
           <div class="navbar-header">
             ...
             <img src="img/logo/android-icon-48x48.png" class="img-responsive" align="middle">
           </div>

            <div class="collapsed navbar-collapse" id="barra-navegacao" >
                <div class="nav navbar-left">
                  <ul class="nav">
                      <li class="topicos">G.R.E.S. Unidos de Vila Isabel</li>
                      <li class="topicos">Guilherme Lacerda</li>
                  </ul>
                </div>
                <div class="nav navbar-right">
                   <ul class="nav">
                      <li class="barrinha"><button type="button" class="btn btn-default">Sair</button></li>
                      <li class="barrinha"><button type="button" class="btn btn-default">Minha Conta</li>
                   </ul>
                </div>         
            </div>    
      </nav>
        ...
        <div class="row">
          <div class="col-md-3">
              <table class="table table-condensed table-striped table-color table-bordered">
                ...
                <tr rowspan="3">
                  <td colspan="2"><img src="img/bandeira.png" class="img-responsive"></td>
                </tr>
                <tr>
                  <td>Região</td>
                  <td>Vila Isabel</td>
          ...
          <div class="col-md-6">
            ...
            <div class="row">
                <div class="col-md-6"align="center">
                    ...
                    <div class=" progress-bar" style="width: 59%; font-size: 16px;">59</div>
                    </div>
                    </div>
                    <div class="row prog-row">
                    <h4>Moral com a Comunidade</h4>
                     <div class="progress" style="height: 25px">
                     <div class=" progress-bar" style="width: 89%; font-size: 16px"">89</div>
                    </div>
                    </div>
                    <div class="row prog-row">
                    <h4>Moral na Imprensa</h4>
                     <div class="progress" style="height: 25px">
                      <div class=" progress-bar"  style="width: 75%; font-size: 16px"">75</div>
                    </div>
                    </div>
                </div>
                <div class="col-md-6" align="center">
          ...
          <div class="col-md-3">
            <table class=" table-bordered table table-layout  table-striped table-color table-condensed text-center ">
              <thead></thead>
              <th>Escolas</th>
              <th>Chão</th>
              <th>Barracão</th>
              ...
              <tr>
                ...
                <td>OK</td>
                <td>Atrasado</td>
                <td>Descobrimento da Australia</td>
              </tr>
              <tr>
                <td>Imperatriz</td>
                <td>OK</td>
